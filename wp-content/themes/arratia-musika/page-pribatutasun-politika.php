...
<div class="privacy-page">
    <div class="container" style="max-width:860px;">
        ...
        <div class="privacy-lang-tabs">
            <button class="privacy-tab privacy-tab--active" data-lang="eu">EU</button>
            <button class="privacy-tab" data-lang="es">ES</button>
        </div>
        ...
        <div class="privacy-body" id="privacy-eu">
            ...
            <table class="privacy-table">
                <tr>
                    <td>Izena</td>
                    <td>Arratiako Musika Eskola</td>
                </tr>
                <tr>
                    <td>Helbidea</td>
                    <td><?php echo esc_html(ARRATIA_HELBIDEA); ?></td>
                </tr>
                <tr>
                    <td>Telefonoa</td>
                    <td><?php echo esc_html(ARRATIA_TELEFONO); ?></td>
                </tr>
                <tr>
                    <td>Helbide elektronikoa</td>
                    <td><a href="mailto:<?php echo esc_attr(ARRATIA_EMAIL); ?>"><?php echo esc_html(ARRATIA_EMAIL); ?></a></td>
                </tr>
            </table>
            ...
            <ul>
                ...
                <li><strong>Ikastetxearen jarduerei</strong> buruzko informazioa bidaltzea interes legitimoan oinarritzen da (DBEOren 6.1.f art.) ikasle aktiboak badira, edo baimenean oinarritzen da ikasle ohiak edo hirugarrenak badira.</li>
            </ul>
            ...
            <ul>
                ...
                <li>Halaber, erreklamazioa aurkezteko eskubidea du Agencia Española de Protección de Datos-ren aurrean, haren egoitza elektronikoaren bidez (www.aepd.es
                    ), tratamendua indarreko araudira egokitzen ez dela uste badu.</li>
            </ul>
        ...
        <div class="privacy-body" id="privacy-es" style="display:none;">
            ...
            <ul>
                ...
                <li><strong>El envío de información</strong> sobre actividades de la escuela se basa en el Interés Legítimo (Art. 6.1.f RGPD) si son alumnos activos, o en el consentimiento si son antiguos alumnos o terceros.</li>
            </ul>
            ...
            <ul>
                ...
                <li>Asimismo, tiene derecho a presentar una reclamación ante la Agencia Española de Protección de Datos (AEPD) a través de su sede electrónica (www.aepd.es) si considera que el tratamiento no se ajusta a la normativa vigente.</li>
            </ul>
...
<script>
    (function() {
        ...
        var panels = {
            eu: document.getElementById('privacy-eu'),
            es: document.getElementById('privacy-es')
        };
